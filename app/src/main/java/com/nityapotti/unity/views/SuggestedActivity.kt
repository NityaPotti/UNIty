...
//
//
//class SuggestedActivity: Fragment() {
//    companion object {
//        private const val TAG = "SuggestedActivity"
//    }
...
//                userList = documents.map { it.toObject(Preference::class.java) } as MutableList<Preference>
//
//                db.collection("userPref").document(uid).get()
//                    .addOnSuccessListener { document ->
//                        val currentUser = document.toObject(Preference::class.java) ?: return@addOnSuccessListener
//
...
//
//                        filteredList.clear()
//                        filteredList.addAll(fullyRankedUserList.map { it.user })
//
